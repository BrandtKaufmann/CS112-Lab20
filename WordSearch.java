...
public class WordSearch {
	...
	static void ConvertColToUpper(char[][] puzzle, int col, int start, int end) {
		for(int n = start; n < end; n++) {
	...
	static boolean SearchBwd(char[][] puzzle, String word) {
		...
		return SearchFwd(puzzle, newWord);
	}
	...
	static boolean SearchDown(char[][] puzzle, String word) {
		...
		// This requires a bit more work than SearchBwd().
		// You need to operate on columns of the puzzle rather than rows.
	}
	...
	static boolean SearchUp(char[][] puzzle, String word) {
		...
		return SearchDown(puzzle, newWord);
	}
